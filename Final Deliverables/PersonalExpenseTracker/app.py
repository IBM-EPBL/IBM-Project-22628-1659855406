...
app.config['hostname'] = '3815fa4db-dc03-4c70-869a-a9cc13f33084.bs2io90l08kqb1od8lcg.databases.appdomain.cloud'
app.config['port'] = '30367'
app.config['protocol'] = 'tcpip'
app.config['uid'] = 'jrm20237'
app.config['pwd'] = 'N652vI62VGYeo5y0'
app.config['security'] = 'SSL'
try:
    mysql = DB2(app)

    conn_str='database=bludb;hostname=815fa4db-dc03-4c70-869a-a9cc13f33084.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;port=30367;protocol=tcpip;\
...
def addexpense():
    ...
    if total > int(s):
        msg = "Hello " + session['username'] + " , " + "you have crossed the monthly limit Team Personal Expense Tracker."  
